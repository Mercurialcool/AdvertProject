...
public class SqlProvider {
    ...
    public static final String SQL_FIND_USERS_ADVERTISEMENTS = "SELECT *FROM adverts WHERE users_userId = ?";
    ...
    public static final String SQL_FIND_BY_SECTION_ADVERT = "SELECT *from adverts WHERE sections_sectionId = ?";
    ...
    public static final String SQL_FIND_EMAIL_BY_USER = "SELECT email FROM users WHERE userName = ?";
}
