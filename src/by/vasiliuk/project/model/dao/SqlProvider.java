...
public class SqlProvider {
    ...
    public static final String SQL_FIND_ALL_USERS = "SELECT userName, userAverageRating, userRole, userStatus FROM users";
    ...
    public static final String SQL_FIND_USERS_ADVERTISEMENTS = "SELECT userId" + "";
    public static final String SQL_ADVERT_SAVE = "INSERT INTO adverts (advertTitle, advertText) VALUES (?, ?)";
